          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground">@stox</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2">
          <div className="p-8 md:p-12">
            ...
            <div className="mt-6 space-y-3">
              <p className="font-medium">Op dinsdag t/m donderdag, na 17.00 uur maken we heel graag tijd voor je.</p>
              <p className="font-medium mt-4">Bel gerust!</p>
            </div>
